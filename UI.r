...
shinyUI(
  navbarPage("Shiny Application",
             ...
             tabPanel("Go back to my Github repository",
                      a("https://github.com/kaumod/Data-Products-/tree/master"),
                      hr(),
                      h4("I hope you would like the Shiny App"),
                      h4("The name of the repository is Developing Data Products Week 4 Course Project in John Hokins University")
             )
  )
)
